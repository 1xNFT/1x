...
const Home = () => {
  const tokenAddress = "0x9dA464Af97b609b82085f12fB60FaE5e713CedE1";
    ...
    <div className={styles.container}>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <h2 className={styles.title}>Claim Airdrop Tokens</h2>
          <p className={styles.explain}>
            Anyone Can Claim 1000 <span className={styles.pink}>${contractMetadata?.name}</span> | Eligible user can claim more
